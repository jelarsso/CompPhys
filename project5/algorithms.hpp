...
void backward_euler(int, double, double,double,double, int, arma::Col<double>*,std::string);
void forward_euler(int, double, double, double, double, int, arma::Col<double>*,std::string);
void forward_euler2d(int,double,double,int,arma::Mat<double>*,std::string);
void cranky_nicholson(int, double, double, double, double, int, arma::Col<double>*, std::string);
