...
void output(int, int, arma::Mat<double>*, std::string);
void forward_euler2d_litho(int, int, double,double,double,double,double,double,double, double, int, arma::Mat<double>*,std::string);
void forward_euler2d_litho_pb(int, int, double,double,double,double,double,double, double, int, arma::Mat<double>*,std::string);
void close();
